...
import HomeAiDemo from "@/components/HomeAiDemo";
  ...
  return (
    <div className="relative min-h-screen bg-white text-slate-900 font-sans overflow-hidden selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-0 right-0 w-150 h-150 bg-indigo-50/80 blur-[100px] rounded-full opacity-70" />
        {/* Soft Purple Gradient Bottom Left */}
        <div className="absolute bottom-0 left-0 w-125 h-125 bg-violet-50/80 blur-[100px] rounded-full opacity-70" />
      </div>
      ...
      <section className="relative z-10 pt-32 pb-24 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <HomeAiDemo dashOrSignUp={dashOrSignUp} />
        </div>
      </section>
